...
<p align="center">
  <small>Initiated feb 2022.</small>
</p>
...
1) Install react icons `npm install react-icons --save`
2) Once node and npm are installed run `npm run start` in the terminal command line.
3) Click `http://localhost:3000/` to open website.
4) Navigate through pages using the navbar or mobile menu.
5) Install react icons `npm install react-icons --save`

Once node and npm are installed run `npm run start` in the terminal command line.
